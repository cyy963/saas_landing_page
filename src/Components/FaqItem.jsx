  ...
  return (
    <div className="relative z-2 mb-16">
      ...
      >
        ...
        <div
          className={clsx(
            "faq-icon relative flex size-12 items-center justify-center rounded-full border-2 border-s2 shadow-400 transition-all duration-0 group-hover:border-s4",
      ...
      active && "opacity-100"
        ...
        <div className="g-4 absolute inset-0.5 -z-1 rounded-3xl"/>
